    ...
    >
      ...
      <div className="form-group">
        ...
        <div className="input-with-icon">
          ...
          />
          <button className="remove-waypoint-btn" onClick={onRemove}>
            <FaTimes />
          </button>
          ...
          directionsServiceRef.current.route(
            ...
            (response: any, status) => {
              ...
              if (status === "OK") {
                ...
                // Generate route options for selection
                const options: any = response.routes.map(
                  (route: any, index: any) => {
                    const distance = route.legs[0].distance.text;
                    const duration = route.legs[0].duration.text;
                    const summary = route.summary || `Route ${index + 1}`;
      ...
      <div className="route-editor">
        <div className="editor-container">
          <div className="left-panel rounded-md px-4 py-4">
            <h2>{initialRoute ? "Edit Route" : "Create Route"}</h2>
              ...
              <div className="route-options">
                ...
                <div className="route-options-list">
                  {routeOptions.map((routeOpt, index) => {
                    console.log("Route Option:", routeOpt); // Print routeOpt
                    return (
                      <div
                        key={index}
